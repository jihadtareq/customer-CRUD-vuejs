        ...
        <form @submit.prevent="storeCustomer(form)">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input v-model="form.phone" type="tel" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123-45-678"  required>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <select v-model="form.typeId" id="customer_types" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <div v-if="errors.password_confirmation">
                        <span class="text-sm text-red-400">{{ errors.password_confirmation[0] }}</span>
                    </div>
                </div> 
            </div>
